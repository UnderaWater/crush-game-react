...
const App = () => {
  ...
  const checkColumnOfFour = () => {
    for (let i = 0; i <= 39; i++) {
      ...
      if (columnOfFour.every(item => currentColors[item] === decidedColor && !isBlank)) {
  ...
  const checkRowOfFour = () => {
    for (let i = 0; i < 64; i++) {
      ...
      if (rowOfFour.every(item => currentColors[item] === decidedColor && !isBlank)) {
        setScore((score) => score + 4);
  ...
  const checkColumnOfThree = () => {
    for (let i = 0; i <= 47; i++) {
      ...
      if (columnOfThree.every(item => currentColors[item] === decidedColor && !isBlank)) {
  ...
  const checkRowOfThree = () => {
    for (let i = 0; i < 64; i++) {
      ...
      if (rowOfThree.every(item => currentColors[item] === decidedColor && !isBlank)) {
        setScore((score) => score + 3);
